		...
		<div class="container">
			<div class="title__row">
				...
				<div class="title__lang">
					<a href="create?lang=en"><spring:message code="lang.en"/></a>
						<a href="create?lang=ru"><spring:message code="lang.ru"/></a>
												<br><br>
				...
				<div class="news__list">							
 				...
 				<form:form action="save" modelAttribute="news" method="post"> 
					...
					<div class="edit__news">
						...
						<spring:message code="title.title" var="title_placeholder"/>
						<form:input path="title" class="edit__textbox1" placeholder='${title_placeholder}' />
					...
					<div class="edit__news">
						...
						<spring:message code="title.brief" var="brief_placeholder"/>
						<form:textarea path="brief" wrap="soft" placeholder='${brief_placeholder}' class="edit__textbox3" />
					...
					<div class="edit__news">
						...
						<spring:message code="title.content" var="content_placeholder"/>
						<form:textarea path="content" wrap="soft" placeholder="${content_placeholder}" class="edit__textbox4" /> 
